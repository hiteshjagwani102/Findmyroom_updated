...
const MapNavigator = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="create" component={CreateAd} options={{ headerShown: false }}/>
...
const ListNavigator = () => {
  return (
    <Stack.Navigator>
        <Stack.Screen name="home" component={ItemsList} options={{ headerShown: false }}/>
...
const TabNavigator = () => {
  return (
    ...
    >
      ...
      <Tab.Screen name="create" component={MapNavigator} options={{ headerShown: false }}/>
